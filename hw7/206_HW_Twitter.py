...
##		data you got back!
while True:
	words = input("Enter Tweet term: ")
	#to quit while loop, don't input anything
	if len(words) < 1: break
	# input data using the function get_data
	d = get_data(words)
...
## 		content from 5 tweets, as shown in the linked example.
	...
	# only iterate 5 times to print 5 
	for i in range(5):
		print("TEXT: " + d["statuses"][i]['text'])
		print("CREATED AT: " + d["statuses"][i]['created_at'] + "\n\n")
